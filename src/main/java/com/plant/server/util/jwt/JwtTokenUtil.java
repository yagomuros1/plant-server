...
public class JwtTokenUtil implements Serializable {
    ...
    public boolean isValidRefreshToken(String token) throws SignatureException {
    ...
    private Date getExpirationDateFromToken(String token) throws SignatureException {
        return getClaimFromToken(token, Claims::getExpiration);
    }

    public String getRoleFromToken(String token) throws SignatureException {
    ...
    public UserDetails getUserDetailsFromToken(String token) throws SignatureException {
