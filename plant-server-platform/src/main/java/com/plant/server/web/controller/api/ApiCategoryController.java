...
public class ApiCategoryController {
    ...
    @GetMapping(path = ApiURL.CATEGORIES, produces = ApiUtils.TYPE_CMG_JSON_V_1_0_0)
    public ResponseEntity<Chunk<CategoryCO>> getCategories(@RequestParam(name = ApiURL.PAGE_PARAM) Optional<Integer> page) {
        return ResponseEntity.ok().body(this.categoryService.getCategories(page));
    }
